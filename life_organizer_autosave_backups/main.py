...
auto_save_path = "calendar.txt"
backup_file = "backups/backup.txt"
main_list = []
...
def back_up_checker():
  ...
  if os.path.exists(backup_dir):
    backup_file = "backups/backup.txt"
    bfd = os.open(backup_file, os.O_RDWR | os.O_CREAT)
    os.close(bfd)
  else:
    os.mkdir("backups")
    backup_file = "backups/backup.txt"
...
def auto_save_checker():
    fd = os.open(auto_save_path, os.O_RDWR | os.O_CREAT)
    os.close(fd)
    try:
